...
companion paper~\cite{Kunert2026}.  The correspondence involves a change of
rotation number: for slope $\alpha/\beta$ and window parameter $\omega$, one
period window of the companion's projected point set is, after rescaling by
$1/D$, a translate modulo~$1$ of the orbit $\orb(c/D,\,N')$ with
$D=\alpha^2+\beta^2$, $c\equiv-\alpha^{-1}\beta\pmod D$, and
$N'=\lfloor\omega\alpha\rfloor+\lfloor\omega\beta\rfloor+1$---not of
$\orb(\alpha/\beta,\,\cdot\,)$ itself.  The three-gap theorem bounds the number
