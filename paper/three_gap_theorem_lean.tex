...
the first machine-checked proof of the theorem---in any system---valid
uniformly for rational and irrational~$a$, and the theorem remains absent
from Mathlib at the time of writing: the prior formal proofs we are aware
of---Mayero's Coq development after van Ravenstein, and recent independent
Lean~4 developments, one of them proposed to Mathlib but closed
unmerged---are all restricted to irrational~$a$.  The geometric crux, that the longest gap contains no orbit
...
is set aside.  The prior formalizations of the theorem we are aware of all
inherit such an irrationality hypothesis: Mayero's Coq
development~\cite{Mayero2000}, which follows van Ravenstein, and recent
independent Lean~4 developments---most notably one proposed to Mathlib but
closed unmerged~\cite{SaarShai2026}, which follows Liang's rigid-gap
argument yet likewise assumes $a$ irrational.  We close
...
formalization of the three-gap theorem in Lean~4 valid uniformly for
rational and irrational~$a$---indeed the first machine-checked proof, in
any system, with this uniformity.  The theorem remains absent from Mathlib
at the time of writing, and the other Lean~4 formalizations we are aware
of, most notably one proposed to Mathlib but closed
unmerged~\cite{SaarShai2026}, are restricted, like Mayero's, to
irrational~$a$.  We do \emph{not}
...
\emph{Formalization.}  The prior formal proofs we are aware of are all
restricted to irrational rotation numbers.  The earliest is
Mayero's~\cite{Mayero2000}, carried out in Coq (now Rocq) and following van
Ravenstein.  In 2026, independent Lean~4 formalizations of the irrational
case appeared, most notably one proposed to Mathlib as pull request
\#40037~\cite{SaarShai2026}, which was closed without being
merged.  At the time of writing the
theorem is therefore absent from Mathlib, and we know of no Isabelle
formalization.  Our development is, to our knowledge, the first
machine-checked proof---in any system---valid
